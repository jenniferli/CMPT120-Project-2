...
locations[1].item.description = "Make sure you do not lose the sword because you will need it later on to fight the big boss.";
...
locations[4].description = "You are in a forest surrounded by trees and shrubs. The map guides you to the deep end of the forest, where you encounter the big boss. Use your sword to eliminate him by typing 'kill' in the command box.";
